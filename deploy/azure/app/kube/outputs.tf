...
output "servicebus_namespace" {
  ...
  value       = contains(split(",", var.app_bus_type), "servicebus") ? module.servicebus.*.servicebus_namespace[0] : ""
}

output "servicebus_topic_name" {
  description = "Name of the topic"
  value       = contains(split(",", var.app_bus_type), "servicebus") ? module.servicebus.*.servicebus_topic_name[0] : ""
}

output "servicebus_subscription_name" {
  description = "Servicebus Subscription name"
  value       = contains(split(",", var.app_bus_type), "servicebus") ? module.servicebus.*.servicebus_subscription_name[0] : ""
}

output "servicebus_connectionstring" {
  value     = contains(split(",", var.app_bus_type), "servicebus") ? module.servicebus.*.servicebus_connectionstring[0] : ""
  sensitive = true
}

output "servicebus_subscription_filtered_name" {
  description = "Servicebus Subscription filtered name"
  value       = contains(split(",", var.app_bus_type), "servicebus") ? module.servicebus.*.servicebus_subscription_filtered_name[0] : ""
}

output "servicebus_subscription_id" {
  description = "Servicebus Subscription ID"
  value       = contains(split(",", var.app_bus_type), "servicebus") ? module.servicebus.*.servicebus_subscription_id[0] : ""
}

output "servicebus_subscription_filtered_id" {
  description = "Servicebus Subscription filtered ID"
  value       = contains(split(",", var.app_bus_type), "servicebus") ? module.servicebus.*.servicebus_subscription_filtered_id[0] : ""
}
...
output "eventhub_connectionstring" {
  value     = contains(split(",", var.app_bus_type), "eventhub") ? module.eventhub.*.eventhub_connectionstring[0] : ""
  sensitive = true
}

# Events - Eventhub
output "eventhub_name" {
  value = contains(split(",", var.app_bus_type), "eventhub") ? module.eventhub.*.eventhub_name[0] : ""
}

output "eventhub_sa_connectionstring" {
  value     = contains(split(",", var.app_bus_type), "eventhub") ? module.eventhub.*.eventhub_sa_connectionstring[0] : ""
  sensitive = true
}

output "eventhub_sa_container" {
  value = contains(split(",", var.app_bus_type), "eventhub") ? module.eventhub.*.eventhub_sa_container[0] : ""
}

output "eventhub_function_listener_name" {
  value = contains(split(",", var.app_bus_type), "eventhub") ? module.eventhub.*.function_listener_name[0] : ""
}

output "eventhub_function_listener_id" {
  value = contains(split(",", var.app_bus_type), "eventhub") ? module.eventhub.*.function_listener_id[0] : ""
}
