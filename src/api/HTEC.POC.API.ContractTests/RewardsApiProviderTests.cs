...
using HTEC.POC.API.ContractTests.Fixtures;
using HTEC.POC.Infrastructure;

namespace HTEC.POC.API.ContractTests;

public class RewardsApiProviderTests
{
    private string ProviderUri { get; }
    private ITestOutputHelper OutputHelper { get; }

    private readonly ConfigModel Config;
    private const string ProviderName = "RewardsAPI";
    private readonly PactVerifierConfig PactConfig;

    public RewardsApiProviderTests(ITestOutputHelper output)
    {
        OutputHelper = output;
