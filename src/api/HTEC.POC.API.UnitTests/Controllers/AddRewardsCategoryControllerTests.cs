...
public class AddRewardsCategoryControllerTests
{
    [Fact]
    public void AddRewardsCategoryController_Should_BeDerivedFrom_ApiControllerBase()
    {
        // Arrange
        // Act
        // Assert
        typeof(AddRewardsCategoryController)
            .Should()
    ...
    public void Constructor_Should_ThrowArgumentNullException_When_ICommandHandlerIsNull()
    {
        // Arrange
        // Act
        Action action = () => new AddRewardsCategoryController(null);
    ...
    public void Constructor_Should_Not_Throw_When_ICommandHandlerIsPresent()
    {
        // Arrange
        // Act
        Action action = () => new AddRewardsCategoryController(Substitute.For<ICommandHandler<CreateCategory, Guid>>());
    ...
    [Fact]
    public void AddRewardsCategory_Should_BeDecoratedWith_HttpPostAttribute()
    {
        // Arrange
        // Act
        // Assert
        typeof(AddRewardsCategoryController)
            .Methods()
            .First(x => x.Name == "AddRewardsCategory")
            .Should()
            .BeDecoratedWith<HttpPostAttribute>(attribute => attribute.Template == "/v1/rewards/{id}/category/");
    }

    [Fact]
    public void AddRewardsCategory_Should_BeDecoratedWith_AuthorizeAttribute()
    {
        // Arrange
        // Act
        // Assert
    ...
    [Fact]
    public void AddRewardsCategory_Should_BeDecoratedWith_ProducesResponseTypeAttribute()
    {
        // Arrange
        // Act
        // Assert
    ...
    [Fact]
    public async Task AddRewardsCategory_Should_Return_StatusCodeCreated()
    {
        // Arrange
        ...
        var sut = new AddRewardsCategoryController(fakeCommandHandler)
        {
        ...
        // Act
        var result = await sut.AddRewardsCategory(Guid.Empty, body);
