...
public class UpdateRewardsCategoryControllerTests
{
    [Fact]
    public void UpdateRewardsCategoryController_Should_BeDerivedFrom_ApiControllerBase()
    {
        // Arrange
        // Act
        // Assert
        typeof(UpdateRewardsCategoryController)
            .Should()
    ...
    public void Constructor_Should_ThrowArgumentNullException_When_ICommandHandlerIsNull()
    {
        // Arrange
        // Act
        Action action = () => new UpdateRewardsCategoryController(null);
    ...
    public void Constructor_Should_Not_Throw_When_ICommandHandlerIsPresent()
    {
        // Arrange
        // Act
        Action action = () => new UpdateRewardsCategoryController(Substitute.For<ICommandHandler<UpdateCategory, bool>>());
    ...
    public void UpdateCategory_Should_BeDecoratedWith_HttpPutAttribute()
    {
        ...
        typeof(UpdateRewardsCategoryController)
            .Methods()
            .First(x => x.Name == "UpdateRewardsCategory")
            .Should()
            .BeDecoratedWith<HttpPutAttribute>(attribute => attribute.Template == "/v1/rewards/{id}/category/{categoryId}");
    }
    ...
    public async Task UpdateCategory_Should_Return_StatusCodeNoContent()
    {
        ...
        var sut = new UpdateRewardsCategoryController(fakeCommandHandler)
        {
        ...
        // Act
        var result = await sut.UpdateRewardsCategory(Guid.Empty, Guid.Empty, body);
