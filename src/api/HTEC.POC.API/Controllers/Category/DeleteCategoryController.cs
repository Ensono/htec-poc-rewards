    ...
    // ReSharper disable once ArrangeNamespaceBody
{
    ...
    public class DeleteCategoryController : ApiControllerBase
    {
        ...
        /// <summary>
        /// Removes a category and its items from rewards
        /// </summary>
        /// <remarks>Removes a category and its items from rewards</remarks>
        /// <param name="id">rewards id</param>
        /// <param name="categoryId">Id for Category being removed</param>
        /// <response code="204">No Content</response>
        /// <response code="400">Bad Request</response>
        /// <response code="404">Resource not found</response>
        [HttpDelete("/v1/rewards/{id}/category/{categoryId}")]
        [Authorize]
