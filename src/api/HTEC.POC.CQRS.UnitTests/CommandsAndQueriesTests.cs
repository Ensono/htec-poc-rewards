...
public class CommandsAndQueriesTests
{
    ...
    {
        var assembly = typeof(CreateRewards).Assembly;
    ...
    {
        var definitions = typeof(CreateRewards).Assembly.GetImplementationsOf(typeof(ICommand));
    ...
    {
        var definitions = typeof(CreateRewards).Assembly.GetImplementationsOf(typeof(IOperationContext));
    ...
    {
        var definitions = typeof(GetRewardsById).Assembly.GetImplementationsOf(typeof(IQueryCriteria));
        foreach (var definition in definitions)
        {
            var operationCode = GetOperationCode(definition.implementation);
            var operationName = GetOperationName(operationCode);
    ...
    {
        var commands = typeof(CreateRewards)
            .Assembly
    ...
    {
        var queries = typeof(GetRewardsById)
            .Assembly
            .GetImplementationsOf(typeof(IQueryCriteria))
            .Select(c => c.Item2);

        var handlers = typeof(GetRewardsByIdQueryHandler)
            .Assembly
