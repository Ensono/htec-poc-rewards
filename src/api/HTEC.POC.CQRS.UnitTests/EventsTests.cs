...
public class EventsTests
{
    ...
    {
        var assembly = typeof(RewardsCreatedEvent).Assembly;
    ...
    {
        var definitions = typeof(RewardsCreatedEvent).Assembly.GetImplementationsOf(typeof(IApplicationEvent));
