...
public static class DependencyRegistration
{
    ...
    public static void ConfigureProductionDependencies(WebHostBuilderContext context, IServiceCollection services)
    {
        services.AddSecrets();
            ...
            services.AddTransient<IRewardsRepository, InMemoryRewardsRepository>();
    ...
    private static void AddCommandHandlers(IServiceCollection services)
    {
        ...
        var definitions = typeof(CreateRewardsCommandHandler).Assembly.GetImplementationsOf(typeof(ICommandHandler<,>));
    ...
    private static void AddQueryHandlers(IServiceCollection services)
    {
        ...
        var definitions = typeof(GetRewardsByIdQueryHandler).Assembly.GetImplementationsOf(typeof(IQueryHandler<,>));
        foreach (var definition in definitions)
        {
            log.Information("Registering '{implementation}' as implementation of '{interface}'",
                definition.implementation.FullName, definition.interfaceVariation.FullName);
