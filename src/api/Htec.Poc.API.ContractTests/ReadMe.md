...
If the tests need to run against a different version of the contracts, version within the source code will need to be updated. See `private string CreatePactUri(string consumerName, string providerName)` within the class `RewardApiProviderTests.cs`
...
This can be seen within `RewardApiProviderTests.cs`
