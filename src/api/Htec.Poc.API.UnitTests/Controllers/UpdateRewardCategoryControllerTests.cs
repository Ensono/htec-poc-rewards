...
public class UpdateRewardCategoryControllerTests
{
    [Fact]
    public void UpdateRewardCategoryController_Should_BeDerivedFrom_ApiControllerBase()
    {
        // Arrange
        // Act
        // Assert
        typeof(UpdateRewardCategoryController)
            .Should()
    ...
    public void Constructor_Should_ThrowArgumentNullException_When_ICommandHandlerIsNull()
    {
        // Arrange
        // Act
        Action action = () => new UpdateRewardCategoryController(null);
    ...
    public void Constructor_Should_Not_Throw_When_ICommandHandlerIsPresent()
    {
        // Arrange
        // Act
        Action action = () => new UpdateRewardCategoryController(Substitute.For<ICommandHandler<UpdateCategory, bool>>());
    ...
    public void UpdateCategory_Should_BeDecoratedWith_HttpPutAttribute()
    {
        ...
        typeof(UpdateRewardCategoryController)
            .Methods()
            .First(x => x.Name == "UpdateRewardCategory")
            .Should()
            .BeDecoratedWith<HttpPutAttribute>(attribute => attribute.Template == "/v1/reward/{id}/category/{categoryId}");
    }
    ...
    public async Task UpdateCategory_Should_Return_StatusCodeNoContent()
    {
        ...
        var sut = new UpdateRewardCategoryController(fakeCommandHandler)
        {
        ...
        // Act
        var result = await sut.UpdateRewardCategory(Guid.Empty, Guid.Empty, body);
