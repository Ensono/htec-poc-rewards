        ...
        IOptions<JwtBearerAuthenticationConfiguration> jwtBearerAuthenticationOptions)
    {
        ...
        app
            ...
            .UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("all/swagger.json", "Reward (all)");
                c.SwaggerEndpoint("v1/swagger.json", "Reward (version 1)");
                c.SwaggerEndpoint("v2/swagger.json", "Reward (version 2)");
        ...
        services
            ...
            .AddSwaggerGen(c =>
            {
                c.SwaggerDoc("all", new OpenApiInfo
                {
                    Version = "all",
                    Title = "Reward API",
                    Description = "APIs used to interact and manage rewards for a restaurant",
                ...
                c.IncludeXmlComments(
                    $"{AppContext.BaseDirectory}{Path.DirectorySeparatorChar}{typeof(CreateRewardRequest).Assembly.GetName().Name}.xml");

                //Set default tags, shows on top, non defined tags appears at bottom
                c.DocumentFilter<SwaggerDocumentTagger>(
                    new OpenApiTag[]
                    {
                        new OpenApiTag {Name = "Reward"}, new OpenApiTag {Name = "Category"},
