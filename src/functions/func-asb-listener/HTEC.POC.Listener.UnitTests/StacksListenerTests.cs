...
public class StacksListenerTests
{
    ...
    public void TestExecution()
    {
        ...
        msgReader.Received(1).Read<StacksCloudEvent<RewardsCreatedEvent>>(message);
    }

    public RewardsCreatedEvent BuildMessageBody()
    {
        var id = Guid.NewGuid();
        return new RewardsCreatedEvent(new TestOperationContext(), id);
    }

    public Message BuildMessage(RewardsCreatedEvent body)
    {
