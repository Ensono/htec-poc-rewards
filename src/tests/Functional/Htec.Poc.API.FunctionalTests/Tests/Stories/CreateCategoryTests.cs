...
[Story(
    ...
    IWant = "to be able to create rewards with categories",
...
public class CreateCategoryTests : IClassFixture<AuthFixture>
{
    ...
    [Fact]
    public void Create_category_for_reward()
    {
        this.Given(step => fixture.GivenAUser())
            .And(step => categorySteps.GivenIHaveSpecfiedAFullCategory())
            .When(step => categorySteps.WhenICreateTheCategoryForAnExistingReward())
