...
[Story(
    ...
    IWant = "to be able to create rewards with categories and items",
...
public class CreateItemTests : IClassFixture<AuthFixture>
{
    ...
    [Fact]
    public void Create_item_for_reward()
    {
        this.Given(step => fixture.GivenAUser())
            .And(step => itemSteps.GivenIHaveSpecfiedAFullItem())
            .When(step => itemSteps.WhenICreateTheItemForAnExistingRewardAndCategory())
