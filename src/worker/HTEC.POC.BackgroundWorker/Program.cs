...
using Serilog;
using HTEC.POC.BackgroundWorker.Handlers;

namespace HTEC.POC.BackgroundWorker;
    ...
    public static IHostBuilder CreateWebHostBuilder(string[] args) =>
        Host.CreateDefaultBuilder(args)
            ...
            .ConfigureServices((hostContext, services) =>
            {
                ...
                var definitions = typeof(RewardsCreatedEventHandler).Assembly.GetImplementationsOf(typeof(IApplicationEventHandler<>));
